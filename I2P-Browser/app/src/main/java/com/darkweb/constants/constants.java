...
public class constants
{
    ...
    public static final String BACKEND_GENESIS_URL = "https://bing.com";
    public static final String BACKEND_GENESIS_URL_TOKEN = "";
    ...
    public static final String PLAYSTORE_URL = "https://play.google.com/store/apps/details?id=com.darkweb";
    ...
    public static final boolean PROXY_CACHE = false;
    public static final boolean PROXY_MEMORY = false;
